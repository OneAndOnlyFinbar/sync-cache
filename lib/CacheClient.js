...
exports.CacheClient = exports.GetResponse = void 0;
        ...
        this._ws.onmessage = function (payload) {
            ...
            switch (operation) {
                case 'setKeyResponse': {
                    ...
                    var current = _this.cache.fetchAll();
                ...
                case 'fetchAllResponse': {
                    ...
                    keys.forEach(function (key, i) { return _this.cache.fetchAll()[key] = values_1[i]; });
